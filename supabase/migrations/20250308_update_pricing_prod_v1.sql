...
-- Insertar precios REALES de producción
-- Formato: (route_type, origin_type, destination_type, base_price_1_3, base_price_4_7, description)
...
('lebourget_paris', 'airport', 'city', 77, 99, '{
...
('beauvais_paris', 'airport', 'city', 130, 150, '{
...
INSERT INTO fixed_routes (route_type, origin_type, destination_type, base_price_1_3, base_price_4_7, description) VALUES
('cdg_orly', 'airport', 'airport', 105, 135, '{
    "en": "CDG ↔ Orly",
    "es": "CDG ↔ Orly",
    "fr": "CDG ↔ Orly",
    "pt": "CDG ↔ Orly"
...
('cdg_lebourget', 'airport', 'airport', 77, 99, '{
    "en": "CDG ↔ Le Bourget",
    "es": "CDG ↔ Le Bourget",
    "fr": "CDG ↔ Le Bourget",
    "pt": "CDG ↔ Le Bourget"
...
('orly_lebourget', 'airport', 'airport', 85, 110, '{
    "en": "Orly ↔ Le Bourget",
    "es": "Orly ↔ Le Bourget",
    "fr": "Orly ↔ Le Bourget",
    "pt": "Orly ↔ Le Bourget"
...
INSERT INTO fixed_routes (route_type, origin_type, destination_type, base_price_1_3, base_price_4_7, description) VALUES
('garedunord_paris', 'station', 'city', 55, 72, '{
...
('garelyon_paris', 'station', 'city', 60, 78, '{
...
('garest_paris', 'station', 'city', 55, 72, '{
...
('garemontparnasse_paris', 'station', 'city', 60, 78, '{
...
('garelazare_paris', 'station', 'city', 60, 78, '{
...
INSERT INTO fixed_routes (route_type, origin_type, destination_type, base_price_1_3, base_price_4_7, description) VALUES
('disney_paris', 'attraction', 'city', 95, 120, '{
...
('versailles_paris', 'attraction', 'city', 75, 98, '{
...
INSERT INTO fixed_routes (route_type, origin_type, destination_type, base_price_1_3, base_price_4_7, description) VALUES
('cdg_disney', 'airport', 'attraction', 95, 120, '{
    "en": "CDG → Disneyland",
    "es": "CDG → Disneyland",
    "fr": "CDG → Disneyland",
    "pt": "CDG → Disneyland"
...
('cdg_versailles', 'airport', 'attraction', 80, 104, '{
    "en": "CDG → Versailles",
    "es": "CDG → Versalles",
    "fr": "CDG → Versailles",
    "pt": "CDG → Versalhes"
...
('orly_disney', 'airport', 'attraction', 90, 117, '{
    "en": "Orly → Disneyland",
    "es": "Orly → Disneyland",
    "fr": "Orly → Disneyland",
    "pt": "Orly → Disneyland"
