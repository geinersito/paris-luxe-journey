...
export default function BlogPost() {
  ...
  const currentUrl = `https://parisluxejourney.com/blog/${category}/${slug}`

  const breadcrumbItems = [
    { label: t('blog.title') || 'Blog', href: '/blog' },
    { label: categoryMeta?.name[currentLang] || category!, href: `/blog/${category}` },
  ...
  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    { name: 'Home', url: 'https://parisluxejourney.com' },
    { name: t('blog.title') || 'Blog', url: 'https://parisluxejourney.com/blog' },
    { name: categoryMeta?.name[currentLang] || category!, url: `https://parisluxejourney.com/blog/${category}` },
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content={post.seo.metaDescription[currentLang]} />
        <meta name="keywords" content={post.seo.keywords.join(', ')} />

        {/* Open Graph */}
        <meta property="og:title" content={post.seo.metaTitle[currentLang]} />
        <meta property="og:description" content={post.seo.metaDescription[currentLang]} />
        <meta property="og:image" content={post.image.url} />
        <meta property="og:type" content="article" />
        <meta property="article:published_time" content={post.publishedAt} />
        <meta property="article:modified_time" content={post.updatedAt} />
        <meta property="article:author" content={post.author.name} />
        <meta property="article:section" content={categoryMeta?.name[currentLang]} />
        {post.tags.map((tag) => (
        ...
        <meta name="twitter:description" content={post.seo.metaDescription[currentLang]} />
        <meta name="twitter:image" content={post.image.url} />

        {/* Canonical URL */}
        <link rel="canonical" href={`https://parisluxejourney.com/blog/${category}/${slug}`} />
      </Helmet>
