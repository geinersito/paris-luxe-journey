...
const translations = {
  en: {
    ...
    faq: {
      ...
      a2: "Yes! While tickets and local guides are not included in our base price, we can assist you with recommendations and booking information. If you'd like a licensed local guide at your destination, we can provide referrals for an additional fee (typically €200–300 for a full day).",
  ...
  fr: {
    ...
    faq: {
      ...
      a2: "Oui ! Bien que les billets et les guides locaux ne soient pas inclus dans notre prix de base, nous pouvons vous aider avec des recommandations et des informations de réservation. Si vous souhaitez un guide local agréé sur place, nous pouvons vous fournir des références moyennant des frais supplémentaires (généralement 200–300 € pour une journée complète).",
  ...
  es: {
    ...
    faq: {
      ...
      a2: "¡Sí! Aunque las entradas y guías locales no están incluidos en nuestro precio base, podemos ayudarte con recomendaciones e información de reserva. Si deseas un guía local habilitado en el destino, podemos facilitarte referencias por una tarifa adicional (normalmente €200–300 por día completo).",
  ...
  pt: {
    ...
    faq: {
      ...
      a2: "Sim! Embora ingressos e guias locais não estejam incluídos no nosso preço base, podemos ajudá-lo com recomendações e informações de reserva. Se desejar um guia local credenciado no destino, podemos fornecer referências por uma taxa adicional (normalmente €200–300 por dia completo).",
