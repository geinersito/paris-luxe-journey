...
export default function Events() {
  ...
  return (
    <>
      <Helmet>
        <title>{t('events.pageTitle') || 'Events in Paris | Paris Luxe Journey'}</title>
        <meta
          name="description"
          content={t('events.pageDescription') || 'Discover the best events, concerts, exhibitions and activities happening in Paris this week and month. Book your luxury transfer to any event.'}
        />
        <meta
          name="keywords"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                {t('events.heroSubtitle') || 'Discover the best concerts, exhibitions, shows and cultural events happening in Paris. Book your luxury transfer to arrive in style.'}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  {t('events.bookTransfer') || 'Book Event Transfer'}
                </Button>
                <Button 
                  size="lg" 
                  variant="outline"
          ...
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 rounded-2xl p-8 md:p-12 text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                {t('events.ctaDescription') || 'Book a luxury transfer to any event in Paris. Professional chauffeur, premium vehicles, fixed prices.'}
              </p>
              <Button 
                size="lg" 
                onClick={() => navigate('/booking')}
