...
const TestimonialCard = ({
  ...
  // Extract two clean initials from labels such as "L.M." or "Laura M."
  const initials =
    name
      .replace(/[^A-Za-z]/g, "")
      .toUpperCase()
    ...
    >
      ...
      <div className="flex items-center gap-4 pt-6 border-t border-primary/10 relative z-10">
        <div className="relative w-14 h-14 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-primary/30 group-hover:ring-4 group-hover:ring-primary/50 transition-all duration-300">
          <div className="absolute inset-0 bg-gradient-gold flex items-center justify-center">
        ...
        <div className="flex-1">
          <h4 className="font-display font-bold text-lg text-secondary dark:text-primary-foreground group-hover:text-primary transition-colors duration-300">
            {name}
          </h4>
