...
export const pt: Translation = {
  ...
  hero: {
    ...
    subtitle: "Transfers confortáveis e preços claros",
    proofline:
      "Transfers de aeroporto a partir de €110 · 24/7 · Meet & Greet · Monitoramento de voo",
    langProof: "Atendimento em espanhol",
    bullet1: "Pontualidade e motoristas profissionais",
    bullet2: "Para negócios, famílias e turistas",
    bullet3: "Reserva rápida, confirmação imediata",
    ctaPrimary: "Solicitar orçamento agora",
    ctaSecondary: "Falar com a equipe",
    selectPickup: "Selecionar…",
    selectDropoff: "Selecionar…",
    getInstantQuote: "Solicitar orçamento agora",
