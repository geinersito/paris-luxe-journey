...
export const fr: Translation = {
  ...
  home: {
    ...
    events: {
      title: "Événements à venir à Paris",
      seeAll: "Voir tous les événements →",
      fallback:
        "Vous assistez à un événement à Paris ? Contactez-nous pour votre transfert privé.",
    },
    excursions: {
      title: "Escapades depuis Paris",
      seeAll: "Explorer toutes les excursions →",
      from: "à partir de",
    },
  },
  agencies: {
  ...
  contact: {
    ...
    description: "Contactez notre equipe pour toute demande ou assistance.",
  ...
  about: {
    ...
    years: "Des annees d'experience a Paris",
    description:
      "Nous proposons un transport prive a Paris et en Ile-de-France pour les clients corporate et les voyageurs internationaux, avec ponctualite, discretion et service personnalise.",
    commitment: {
  ...
  seo: {
    home: {
      title:
        "Paris Elite Services | Chauffeur privé et transferts aéroport à Paris",
      description:
