...
export const en: Translation = {
  ...
  hero: {
    title: "Discover Paris. Arrive in style.",
    subtitle:
      "Events, excursions and private day trips with your own licensed chauffeur. Fixed price, 24/7, no surprises.",
    proofline: "",
    langProof: "English · Español · Français",
    bullet1: "Licensed VTC chauffeur",
    bullet2: "Fixed price, no surprises",
