...
export const blogPosts: BlogPostMeta[] = [
  ...
  {
    id: "11",
    slug: "cdg-arrival-guide-brazilian-travelers",
    title: {
      en: "Arriving at CDG: Guide for Brazilian Travelers Before Landing",
      es: "Llegar a CDG: Guía para Viajeros Brasileños Antes de Aterrizar",
      fr: "Arriver à CDG : Guide pour les Voyageurs Brésiliens Avant l'Atterrissage",
      pt: "Chegando ao Aeroporto CDG: guia para brasileiros antes de desembarcar",
    },
    description: {
      en: "A practical arrival guide for Brazilian travelers landing at Charles de Gaulle: documents, baggage, exits, taxis, trains, private transfers, and how to avoid confusion after a long flight.",
      es: "Una guía práctica de llegada para viajeros brasileños que aterrizan en Charles de Gaulle: documentos, equipaje, salidas, taxis, trenes, transfers privados y cómo evitar la confusión después de un vuelo largo.",
      fr: "Un guide d'arrivée pratique pour les voyageurs brésiliens atterrissant à Charles de Gaulle : documents, bagages, sorties, taxis, trains, transferts privés et comment éviter la confusion après un long vol.",
      pt: "Guia prático para brasileiros que chegam ao Charles de Gaulle: documentos, bagagem, saídas, táxis, trem, transfer privado e como evitar confusão depois de um voo longo.",
    },
    category: "transport",
    author: createAuthor("Pierre Dubois", true),
    ...
    image: {
      url: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1200&h=630&fit=crop",
      alt: {
        en: "Arrival terminal at Charles de Gaulle Airport",
        es: "Terminal de llegadas en el Aeropuerto Charles de Gaulle",
        fr: "Terminal des arrivées à l'aéroport Charles de Gaulle",
        pt: "Terminal de chegadas no Aeroporto Charles de Gaulle",
      },
    },
    tags: [
      "cdg arrival guide",
      "brazilian travelers paris",
      "airport transfer",
      "charles de gaulle airport",
    ...
    seo: {
      metaTitle: {
        en: "Arriving at CDG 2026 | Practical Guide for Brazilian Travelers",
        es: "Llegar a CDG 2026 | Guía Práctica para Viajeros Brasileños",
        fr: "Arriver à CDG 2026 | Guide Pratique pour Voyageurs Brésiliens",
        pt: "Chegando ao CDG 2026 | Guia Prático para Brasileiros",
      },
      metaDescription: {
        en: "Everything Brazilian travelers should prepare before landing at CDG: documents, baggage, exits, transport choices, fake taxi precautions, and when private transfer makes sense.",
        es: "Todo lo que los viajeros brasileños deben preparar antes de aterrizar en CDG: documentos, equipaje, salidas, opciones de transporte, precauciones contra taxis falsos y cuándo conviene un transfer privado.",
        fr: "Tout ce que les voyageurs brésiliens doivent préparer avant d'atterrir à CDG : documents, bagages, sorties, options de transport, précautions contre les faux taxis et quand un transfert privé a du sens.",
        pt: "Tudo que brasileiros devem preparar antes de pousar no CDG: documentos, bagagem, saídas, opções de transporte, cuidados com táxis falsos e quando vale pedir um transfer privado.",
      },
      keywords: [
        "cdg arrival guide",
        "charles de gaulle arrival",
        "brazilian travelers paris",
        "paris airport transfer",
        "fake taxi cdg",
        "cdg to paris hotel",
