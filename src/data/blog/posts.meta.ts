...
const createAuthor = (name: string, isPierre: boolean = true) => ({
  name,
  role: {
    en: isPierre ? 'Senior Chauffeur & Transport Expert' : 'Luxury Travel Consultant',
    es: isPierre ? 'Chofer Senior y Experto en Transporte' : 'Consultora de Viajes de Lujo',
    fr: isPierre ? 'Chauffeur Senior et Expert en Transport' : 'Consultante en Voyages de Luxe',
    pt: isPierre ? 'Motorista Sênior e Especialista em Transporte' : 'Consultora de Viagens de Luxo'
  },
  bio: {
    en: isPierre
...
export const blogPosts: BlogPostMeta[] = [
  // TRANSPORT CATEGORY (3 posts)
  {
    ...
    featured: true,
    image: {
      url: '/images/blog/cdg-airport-transport.jpg',
      alt: {
    ...
    tags: ['cdg to paris', 'airport transfer', 'rer b', 'vtc', 'roissybus', 'paris transport'],
    seo: {
      metaTitle: {
      ...
      keywords: ['cdg to paris', 'charles de gaulle airport', 'rer b', 'roissybus', 'paris airport transfer', 'vtc paris', 'uber cdg', 'taxi cdg']
    }
  },
  {
    id: '2',
    ...
    tags: ['vtc vs taxi', 'uber paris', 'paris transport', 'vtc paris', 'taxi regulations'],
    seo: {
      metaTitle: {
      ...
      keywords: ['vtc vs taxi', 'uber paris', 'vtc paris', 'taxi paris', 'paris transport comparison', 'licensed vtc']
    }
  },
  {
    id: '3',
    ...
    tags: ['airport transfer cost', 'cdg prices', 'orly transfer', 'beauvais airport', 'paris transfer fees'],
    seo: {
      metaTitle: {
      ...
      keywords: ['airport transfer cost', 'cdg to paris price', 'orly transfer cost', 'beauvais airport transfer', 'paris transfer fees', 'airport taxi price']
    }
  },
  ...
  // GUIDES CATEGORY (2 posts)
  {
    ...
    featured: false,
    image: {
      url: '/images/blog/complete-paris-guide.jpg',
      alt: {
    ...
    tags: ['paris guide', 'first time paris', 'visit paris', 'paris itinerary', 'paris attractions', 'paris travel tips'],
    seo: {
      metaTitle: {
      ...
      keywords: ['paris guide', 'first time paris', 'visit paris', 'paris travel guide', 'paris attractions', 'paris budget', 'paris accommodation']
    }
  },
  {
    id: '5',
    ...
    featured: false,
    image: {
      url: '/images/blog/3-day-paris-itinerary.jpg',
      alt: {
    ...
    tags: ['paris itinerary', '3 days paris', 'paris day trip', 'versailles', 'montmartre', 'paris planning'],
    seo: {
      metaTitle: {
      ...
      keywords: ['paris itinerary', '3 days paris', 'paris day trip', 'versailles day trip', 'montmartre guide', 'paris planning']
    }
  },
  ...
  // TIPS CATEGORY (3 posts)
  {
    ...
    featured: false,
    image: {
      url: '/images/blog/tourist-mistakes-paris.jpg',
      alt: {
    ...
    tags: ['paris mistakes', 'tourist traps', 'paris tips', 'avoid scams', 'paris metro', 'travel mistakes'],
    seo: {
      metaTitle: {
      ...
      keywords: ['paris mistakes', 'tourist traps paris', 'paris scams', 'avoid mistakes paris', 'paris metro tips', 'paris travel mistakes']
    }
  },
  {
    id: '7',
    ...
    featured: false,
    image: {
      url: '/images/blog/paris-metro-guide.jpg',
      alt: {
    ...
    tags: ['paris metro', 'metro guide', 'paris transport', 'metro tickets', 'paris navigation', 'public transport'],
    seo: {
      metaTitle: {
      ...
      keywords: ['paris metro', 'metro guide', 'paris metro tickets', 'metro map paris', 'paris public transport', 'metro navigation']
    }
  },
  {
    id: '8',
    ...
    featured: false,
    image: {
      url: '/images/blog/currency-exchange-paris.jpg',
      alt: {
    ...
    tags: ['currency exchange', 'change euros', 'paris money', 'atm paris', 'credit cards', 'exchange rates'],
    seo: {
      metaTitle: {
      ...
      keywords: ['currency exchange paris', 'change euros', 'paris atm', 'exchange rates paris', 'no fee credit cards', 'money exchange']
    }
  },
  ...
  // CULTURE CATEGORY (2 posts)
  {
    ...
    featured: false,
    image: {
      url: '/images/blog/french-phrases-tourists.jpg',
      alt: {
    ...
    tags: ['french phrases', 'basic french', 'learn french', 'paris language', 'french culture', 'tourist french'],
    seo: {
      metaTitle: {
      ...
      keywords: ['french phrases', 'basic french', 'learn french', 'french for tourists', 'paris language', 'french pronunciation']
    }
  },
  {
    id: '10',
    ...
    featured: false,
    image: {
      url: '/images/blog/latin-restaurants-paris.jpg',
      alt: {
    ...
    tags: ['latin restaurants', 'mexican paris', 'peruvian food', 'argentine restaurants', 'brazilian food', 'paris dining'],
    seo: {
      metaTitle: {
      ...
      keywords: ['latin restaurants paris', 'mexican restaurant paris', 'peruvian food paris', 'argentine restaurant', 'brazilian food', 'latin american cuisine']
    }
  },
]
