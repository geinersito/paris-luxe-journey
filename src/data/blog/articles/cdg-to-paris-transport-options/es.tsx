export default function Article() {
  return (
    <article>
      ...
      <h3>Desventajas</h3>
      <ul>
        <li>No adecuado con equipaje pesado</li>
        <li>Puede estar lleno en horas pico</li>
        <li>Los carteristas apuntan a turistas en esta línea</li>
        <li>Sin servicio directo a la mayoría de hoteles</li>
        <li>Requiere navegar escaleras y conexiones</li>
      </ul>
      ...
      <h3>Ventajas</h3>
      <ul>
        <li>El conductor te recibe en llegadas con cartel con tu nombre</li>
      ...
      <div className="overflow-x-auto my-8">
        <table className="min-w-full border">
          <thead className="bg-secondary/10">
            <tr>
              <th className="border px-4 py-2 text-left">Opción</th>
              <th className="border px-4 py-2 text-left">Precio</th>
              <th className="border px-4 py-2 text-left">Tiempo</th>
              <th className="border px-4 py-2 text-left">Mejor Para</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">Último momento, sin reserva</td>
            </tr>
            <tr>
      ...
      <h3>Elige RER B si:</h3>
      <ul>
        <li>Viajas solo o en pareja</li>
        <li>Tienes equipaje mínimo</li>
        <li>Te sientes cómodo con el transporte público</li>
        <li>El presupuesto es tu máxima prioridad</li>
      </ul>

      <h3>Elige un Taxi si:</h3>
      <ul>
        <li>Llegas tarde en la noche</li>
        <li>No reservaste nada con anticipación</li>
        <li>Quieres servicio puerta a puerta</li>
      </ul>

      <h3>Elige VTC Privado si:</h3>
      <ul>
        <li>Viajas con familia o un grupo</li>
        <li>Tienes equipaje pesado</li>
        <li>Quieres precios fijos garantizados</li>
        <li>Valoras la comodidad y confiabilidad</li>
