export default function Article() {
  return (
    <article>
      ...
      <p>
        There are five main ways to get from Charles de Gaulle Airport to Paris:
      </p>
      ...
      <h3>Cons</h3>
      <ul>
        <li>Not suitable with heavy luggage</li>
        <li>Can be crowded during peak hours</li>
        <li>Pickpockets target tourists on this line</li>
        <li>No direct service to most hotels</li>
        <li>Requires navigating stairs and connections</li>
      </ul>
      ...
      <h3>Pros</h3>
      <ul>
        <li>Direct service (no transfers)</li>
        <li>Luggage storage available</li>
        <li>More comfortable than RER B</li>
        <li>Drops off at central Opéra location</li>
      </ul>

      <h3>Cons</h3>
      <ul>
        <li>Subject to Paris traffic</li>
        <li>Can take over an hour during rush hour</li>
        <li>Still requires onward transport to hotel</li>
      </ul>
      ...
      <h3>Cons</h3>
      <ul>
        <li>Long queues at taxi stands (30-60 min wait)</li>
      ...
      <ul>
        ...
        <li>Rating system ensures quality</li>
      </ul>

      <h3>Cons</h3>
      <ul>
        <li>Surge pricing during peak times</li>
        <li>Must walk to designated pickup zone (5-10 min)</li>
      ...
      <h3>Cons</h3>
      <ul>
        <li>Higher cost than public transport</li>
      ...
      <div className="overflow-x-auto my-8">
        <table className="min-w-full border">
          ...
          <tbody>
            <tr>
              <td className="border px-4 py-2">RER B Train</td>
              <td className="border px-4 py-2">€11.80</td>
              <td className="border px-4 py-2">30-40 min</td>
              <td className="border px-4 py-2">Solo travelers, tight budget</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">Last-minute, no booking</td>
            </tr>
            <tr>
              <td className="border px-4 py-2">Uber/Bolt</td>
              <td className="border px-4 py-2">€40-70</td>
              <td className="border px-4 py-2">30-60 min</td>
              <td className="border px-4 py-2">Tech-savvy, flexible pricing</td>
            </tr>
            <tr>
      ...
      <h3>Choose RER B if:</h3>
      <ul>
        <li>You're traveling solo or as a couple</li>
        <li>You have minimal luggage</li>
        <li>You're comfortable with public transport</li>
      ...
      <ul>
        ...
        <li>You didn't pre-book anything</li>
        <li>You want door-to-door service</li>
      </ul>

      <h3>Choose Private VTC if:</h3>
      <ul>
