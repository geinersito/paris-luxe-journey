...
1. `#85` - Create missing excursion detail pages (CONTENT-EXCURSIONS-PAGES-ENRICH-01) (`7d45077`)
2. `#83` - Content integrity audit site-wide i18n (CONTENT-AUDIT-SITEWIDE-I18N-01) (`a58416c`)
3. `#82` - Fix canonical URLs for multi-domain support (SEO-BLOG-META-CANONICALS-01) (`c516aff`)
