...
- **OPS-CI-TEST-GATE-01** (P0/R0) — **DOING** — Node 20 pinned via `engines.node`; new `test:ci` script (`vitest run`) added as mandatory CI gate before build. No product code touched. Branch: `chore/ops-ci-test-gate-01`.
