...
| BOOKING-DB-ANTI-DOUBLEBOOK-01b-APP | — | P1 | R2 | DOING | Wire app: persist service_end_datetime + handle overlap (23P01) |  | App-only: real end time in insert, i18n UX error on constraint violation |
