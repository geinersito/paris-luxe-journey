...
|---|---|---|---|---|---|---|---|
| OPS-CI-TEST-GATE-01 | P0 | R0 | Ops/CI | Make CI reproducible on Node 20 and add Vitest as a mandatory CI gate | DOING | `chore/ops-ci-test-gate-01` | Node 20 pinned via `engines.node`; new `test:ci` script (`vitest run`) added to CI before build; no product code touched |
