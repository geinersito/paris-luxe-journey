...
| OPS-STRIPE-LEGACY-DEPRECATE-01 | — | P2 | R0→R1 | DOING | Deprecate legacy stripe-webhooks handler | [#78](https://github.com/geinersito/paris-luxe-journey/pull/78) / `8fd3365` (docs), [#79](https://github.com/geinersito/paris-luxe-journey/pull/79) (telemetry, open) | PR1 (cutover plan); PR2 (deprecation warnings + headers); PR3 (removal after 48-72h zero hits) |
