...
| OPS-FN-CREATE-BOOKING-PAYMENT-NO-RETRY-ON-CONFLICT-01 | — | P1 | R2 | DOING | create-booking-payment: skip retry on deterministic conflicts (23P01/23505) | PR #TBD | Functions-only follow-up: return immediately on conflict; keep retry only for transient failures |
