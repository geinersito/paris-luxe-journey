...
| BLOG-FEATURED-HERO-CARD-01 | P2 | R0 | UX/Blog | Replace Blog featured layout with hero-card horizontal to eliminate awkward empty column | DONE | [#145](https://github.com/geinersito/paris-luxe-journey/pull/145) / `9139c60111898c0e4652d91ca41a7f2e242920a0` | 12-col grid with media left (lg:col-span-5, controlled height), content right (lg:col-span-7, title/excerpt/meta + CTA); maintains family UI with Events/Excursions; layout-only |
