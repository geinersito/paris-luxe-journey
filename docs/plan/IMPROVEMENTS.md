...
| PLJ-OPS-001 | P1 | R0 | Ops | Staging build script fix (node scripts/build-env.cjs) + Supabase CLI bump v2.75→v2.90 in .temp/cli-latest | TODO | — | Staging build command runs OK; no runtime changes |
