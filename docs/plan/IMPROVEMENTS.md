...
| PLJ-TRANS-001 | P1 | R0 | i18n | i18n types + ParisFashion guide copy: src/types/i18n.ts (+53) + en/es/fr/pt (+124 each) | TODO | — | tsc --noEmit passes; all keys valid; blocks PLJ-UI-001 + PLJ-COMP-001 |
