...
| BOOKING-DB-ANTI-DOUBLEBOOK-01b | — | P1 | R2 | DOING | Anti-double-booking: EXCLUDE USING gist with tstzrange |  | DB-only: service_end_datetime + is_active + EXCLUDE constraint. App PR (01b-APP) sets real end times |
