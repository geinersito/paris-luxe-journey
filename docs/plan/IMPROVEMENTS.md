...
|---|---|---|---|---|---|---|---|
| CONTENT-FAQ-FLEET-CONSISTENCY-01 | P2 | R0 | Content/i18n | Remove BMW and unvalidated "<2 years old"/SUV claims from FAQ `vehicleTypes` answer (EN/ES/PT) | DOING | [#237](https://github.com/geinersito/paris-luxe-journey/pull/237) | FR already free of these claims, left untouched. Copy-only i18n change; enables `PR-SEO-FAQ-SCHEMA-01` without amplifying inconsistent fleet claims via structured data. |
