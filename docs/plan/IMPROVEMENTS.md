...
| UX-EXCURSIONS-LIST-COMPACT-01 | — | P1 | R0 | DONE | Excursions list compact pass (hero tightened + overview cards) | [#89](https://github.com/geinersito/paris-luxe-journey/pull/89) / `445cf19` | Compact overview list, reduced long-form sections in list context, i18n keys expanded, detail routes preserved |
