...
| PLJ-ASSETS-001 | P1 | R0 | Assets | Favicon + PWA icon refresh: apple-icon-180.png, favicon.ico, manifest-icon-192/512.maskable.png, manifest.json, index.html branding | TODO | — | CI + browser favicon load + manifest validates |
