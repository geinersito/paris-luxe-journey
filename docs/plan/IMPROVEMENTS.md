...
|---|---|---|---|---|---|---|---|
| CONTENT-FAQ-PAYMENT-SSOT-01B | P0 | R0 | Content/i18n | Fix FAQ `faq.questions.deposit.answer` (FR): remove unsupported "30% acompte / solde later" claim, align with `TermsPage.tsx` ("100% online payment required") and `pricing.payment.method = "100%_online"` | DOING | [#239](https://github.com/geinersito/paris-luxe-journey/pull/239) | Completes EN/FR/ES/PT payment alignment with Terms/pricing (follows `01A`, [#238](https://github.com/geinersito/paris-luxe-journey/pull/238)). `PR-SEO-FAQ-SCHEMA-01` remains BLOCKED — cancellation, advance-notice and 24/7 claims still pending (`CONTENT-FAQ-CANCELLATION-SSOT-01`, `CONTENT-FAQ-ADVANCE-NOTICE-01`, `CONTENT-FAQ-24H-CLAIMS-*`). |
