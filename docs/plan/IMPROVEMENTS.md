...
|---|---|---|---|---|---|---|---|
| CONTENT-FAQ-CANCELLATION-SSOT-01B | P0 | R0 | Content/i18n | Fix FAQ `faq.questions.cancellation.answer` (FR): remove unsupported "24h entièrement remboursé" claim, defer to Conditions + contact, clarify refund is not automatic | DOING | [#241](https://github.com/geinersito/paris-luxe-journey/pull/241) | Completes EN/FR/ES/PT cancellation alignment (follows `01A`, [#240](https://github.com/geinersito/paris-luxe-journey/pull/240)). `PR-SEO-FAQ-SCHEMA-01` remains BLOCKED by advance-notice (24h/48h) and 24/7 claims. |
