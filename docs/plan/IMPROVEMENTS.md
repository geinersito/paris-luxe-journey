...
|---|---|---|---|---|---|---|---|
| CONTENT-FAQ-PAYMENT-SSOT-01A | P0 | R0 | Content/i18n | Fix FAQ `faq.questions.deposit.answer` (EN/ES/PT): remove unsupported "30% deposit / balance later" claim, align with `TermsPage.tsx` ("100% online payment required") and `pricing.payment.method = "100%_online"` | DOING | `fix/content-faq-payment-ssot-01a` | Resolved from `AUDIT-FAQ-CLAIMS-01`: FAQ deposit claim was in direct RUNTIME-MISMATCH with Terms & Conditions and pricing config — no product/Confirmation/Stripe changes in this slice. `01B` (FR) follows immediately; then `CONTENT-FAQ-CANCELLATION-SSOT-01`, `CONTENT-FAQ-ADVANCE-NOTICE-01`, `CONTENT-FAQ-24H-CLAIMS-*`. `PR-SEO-FAQ-SCHEMA-01` remains BLOCKED until this sequence completes. |
