...
| OPS-FN-CREATE-BOOKING-PAYMENT-NO-RETRY-ON-CONFLICT-01 | — | P1 | R2 | TODO | create-booking-payment: skip retry on deterministic conflicts (23P01/23505) |  | Unblocked by RB-00 (#70). Apply to canonical endpoint `create-booking-payment` |
