...
| NAV-HOURLY-01 | P1 | R1 | Navigation | Separate `Hourly` intent from `/booking` wizard | DOING | [#39](https://github.com/geinersito/paris-luxe-journey/pull/39) | Legacy ID: `PR-U1g` |
